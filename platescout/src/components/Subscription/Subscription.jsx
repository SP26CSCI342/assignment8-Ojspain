...
function Subscription() {
  ...
  return (
    <div className="mx-auto">
      <div
        className="relative isolate overflow-hidden px-6 py-10 shadow
bg-[#1e2126]"
      >
        <h2
          className="mx-auto max-w-2xl text-center text-3xl font-bold
tracking-tight sm:text-4xl text-white"
        >
          Get the Latest Eats
        </h2>
        <p
...
text-gray-300"
        ...
        >
          ...
          <input
            ...
            className="min-w-0 flex-auto rounded-md bg-white px-3.5 py-2
text-black shadow-sm sm:text-sm sm:leading-6"
            placeholder="Enter your email"
          />
          <button
            type="submit"
            className="flex-none rounded-md bg-[#cca353] px-3.5 py-2.5
text-sm font-semibold border-0 text-white shadow-sm hover:bg-[#a7874b]"
          >
            Notify me
          </button>
        </form>
